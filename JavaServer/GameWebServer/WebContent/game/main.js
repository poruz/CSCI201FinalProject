...
game.load.image('Ball', "./game/Assets/BlockA.png");

game.load.image('BlockA', "./game/Assets/BlockA.png");

game.load.image('BlockB', "./game/Assets/BlockB.png");

game.load.image('BlockC', "./game/Assets/BlockC.png");

game.load.image('BlockD', "./game/Assets/BlockD.png");

game.load.image('BlockE', "./game/Assets/BlockE.png");

game.load.image('BlockF', "./game/Assets/BlockF.png");
...
game.load.json('level00', './game/Assets/Level00.json');

mLevels.push('level00');

game.load.json('level01', './game/Assets/Level01.json');

mLevels.push('level01');

game.load.json('level02', './game/Assets/Level02.json');

mLevels.push('level02');

game.load.json('level03', './game/Assets/Level03.json');

mLevels.push('level03');

game.load.json('level04', './game/Assets/Level04.json');

mLevels.push('level04');

game.load.json('level05', './game/Assets/Level05.json');

mLevels.push('level05');

game.load.json('level06', './game/Assets/Level06.json');
...
function getCard(direction, magnitude){ //0 = right, 1 = up, 2 = left, 3 = down
	console.log("RAN GETCARD: " + direction + magnitude);
	if(direction == 0){
